# Legacy mixed MCP server guide

> Archived during package adaptation. This snapshot mixed User, Operator, and
> Development responsibilities and is not a current contract. Use
> `docs/usage/MCP_CONSUMER.md`, `docs/operations/MCP_RUNBOOK.md`, or
> `docs/INDEX.md` according to role. The migration map is
> `../TRACEABILITY.md`.
